...
const CALENDAR_INPUT_CLASS =
  "calendar-input w-full px-3.5 py-3 outline-none transition-all";
...
const EVENT_TYPE_SWATCH: Record<
  CalendarEventType,
  string
> = {
  HEARING:
    "calendar-swatch-hearing",

  FILING_DEADLINE:
    "calendar-swatch-deadline",

  CLIENT_MEETING:
    "calendar-swatch-meeting",

  COURT_APPEARANCE:
    "calendar-swatch-court",

  REMINDER:
    "calendar-swatch-reminder",

  OTHER:
    "calendar-swatch-other",
};
...
function Calendar() {
  ...
  const datePickerTriggerRef =
    useRef<HTMLButtonElement | null>(
      null,
    );

  const datePickerPanelRef =
  ...
  useEffect(() => {
    ...
    function onPointerDown(
      ...
      if (
        datePickerPanelRef.current?.contains(
          target,
        ) ||
        datePickerTriggerRef.current?.contains(
          target,
        )
      ) {
        return;
    ...
    <div className="calendar-page min-h-screen bg-background">
      ...
      >
        <main className="mx-auto max-w-[1500px] px-4 pb-20 sm:px-6 lg:px-8">
          ...
          <header className="pt-16 sm:pt-12">

            <div className="flex flex-col gap-7 xl:flex-row xl:items-end xl:justify-between">

              <div className="min-w-0">

                <p className="calendar-kicker flex items-center gap-2 font-mono font-semibold uppercase">
                ...
                <h1 className="calendar-page-title mt-3 font-display leading-[0.92]">
                  Legal Calendar
                </h1>


                <p className="calendar-page-subtitle mt-4 max-w-2xl leading-relaxed">
                  Hearings, filing deadlines,
                  client meetings and court
                  appearances in one controlled
                  schedule.
                </p>
              ...
              <button
                ...
                className="calendar-add-event focus-legal group inline-flex w-fit items-center gap-2 border px-5 py-3 font-mono text-[11px] font-bold tracking-[0.08em] uppercase transition-all hover:-translate-y-0.5"
              >
          ...
          <section
            ...
            className="calendar-summary mt-6 grid overflow-hidden border sm:grid-cols-3"
          >
            ...
            <SummaryStat
              eyebrow="Next in view"
              value={
                nextEventInView
                  ? format(
                      new Date(
                        nextEventInView.start_at,
                      ),
                      "dd MMM",
                    )
                  : "—"
              ...
              label={
                nextEventInView
                  ? `${EVENT_TYPE_LABEL[nextEventInView.event_type]} · ${format(
                      new Date(
                        nextEventInView.start_at,
                      ),
                      "HH:mm",
          ...
          <section className="calendar-shell mt-6 overflow-hidden border shadow-[0_20px_60px_-35px_rgba(0,0,0,0.45)]">
            ...
            <div className="calendar-toolbar flex flex-col border-b xl:flex-row xl:items-stretch">

              {/* Navigation */}

              <div className="calendar-toolbar-group flex items-center gap-2 border-b px-3 py-3 xl:border-b-0 xl:border-r">
                ...
                <button
                  ...
                  className="calendar-today-button focus-legal ml-1 border px-3 py-2 font-mono text-[10px] font-bold tracking-[0.08em] uppercase transition-all"
                >
                  Today
                </button>
              ...
              <div className="calendar-month-heading relative flex min-w-0 flex-1 flex-col gap-3 border-b px-4 py-4 sm:px-5 xl:border-b-0 xl:border-r">
                  ...
                  <div>
                    ...
                    <h2 className="mt-1">
                      ...
                      <button
                        ...
                        className="calendar-month-trigger focus-legal inline-flex items-center gap-2"
                      >
                        ...
                        <ChevronDown
                          className={`calendar-month-trigger-chevron transition-transform ${
                            datePickerOpen
                              ? "rotate-180"
                              : ""
                          }`}
                      ...
                      >
                        {WEEKDAY_LETTERS.map(
                          (
                            ...
                            <span
                              key={`${letter}-${index}`}
                              className="calendar-dp-weekday font-mono"
                            >
                              {
                                letter
                              }
              ...
              <div className="calendar-schedule-count flex items-center justify-between gap-4 px-4 py-3 text-right sm:px-5">
                ...
                <div>
                  ...
                  <p className="mt-1 font-mono text-xs font-semibold text-brass">
                    {loading
                      ? "SYNCING…"
                      : `${String(
                          monthEventCount,
                    ...
                    (
                      ...
                      return (
                        <div
                          ...
                          className={`calendar-day-cell group relative min-h-[108px] cursor-default border-r border-b p-2 transition-colors sm:min-h-[122px] sm:p-2.5 ${
                            isLastColumn
                              ? "border-r-0"
                              : ""
                          } ${
                        ...
                        >
                          ...
                          <div className="calendar-events mt-2 space-y-1">
                            ...
                            {dayEvents.length >
                              ...
                              <button
                                ...
                                className="calendar-more focus-legal px-1 pt-0.5 font-mono font-bold tracking-[0.08em] hover:text-brass"
                              >
                                +
                                {dayEvents.length -
                                  2}{" "}
                          ...
                          {currentMonthDay &&
                            dayEvents.length ===
                              ...
                              <button
                                ...
                                className="calendar-add-day focus-legal absolute bottom-1.5 right-1.5 flex h-6 w-6 items-center justify-center rounded-full border border-transparent opacity-0 transition-all focus-visible:opacity-100 group-hover:border-current group-hover:opacity-100"
                              >
          ...
          <section className="calendar-agenda mt-6 border">

            <div className="flex flex-col gap-4 border-b px-5 py-4 sm:flex-row sm:items-end sm:justify-between">

              <div>

                <p className="font-mono text-[9px] font-bold tracking-[0.16em] text-muted-foreground uppercase">
                  Selected day
                </p>
              ...
              <button
                ...
                className="calendar-agenda-add focus-legal inline-flex w-fit items-center gap-2 border px-3 py-2 font-mono text-[10px] font-bold tracking-[0.1em] uppercase transition-colors"
              >
            ...
            0 ? (
              ...
              <div className="flex min-h-[130px] flex-col items-center justify-center px-6 text-center">
                ...
                <CalendarDays className="h-5 w-5 text-brass-dim" />

                <p className="mt-3 font-display text-base text-parchment">
                  No events scheduled
                </p>
          ...
          <div className="mt-3 flex flex-col gap-1 text-right">
            ...
            <p className="calendar-hint font-mono tracking-[0.1em] uppercase">
              Double-click any date to
              create an event
            </p>

            <p className="calendar-hint font-mono tracking-[0.1em] uppercase">
              Select a day to inspect its
              schedule
            </p>
              ...
              <div className="grid gap-5 sm:grid-cols-2">
                ...
                <Field label="Case association">
                  ...
                  <select
                    ...
                    className={`${CALENDAR_INPUT_CLASS} disabled:cursor-wait disabled:opacity-50`}
                  >
  ...
  return (
    <div className="calendar-summary-stat px-5 py-4 sm:px-6">
      ...
      <div className="mt-2 flex items-baseline gap-3">
        ...
        <span className="calendar-summary-value font-display">
          {value}
        </span>
...
function LegendItem({
  ...
  return (
    <span className="calendar-legend calendar-legend-item inline-flex items-center font-mono uppercase">
      ...
      <span
        aria-hidden="true"
        className={`calendar-legend-swatch ${swatch}`}
      />
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="calendar-event-time mt-1.5 flex items-center gap-1 font-mono font-semibold">
          <Clock3
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="focus-legal flex w-full items-start gap-4 px-5 py-4 text-left transition-colors sm:px-6"
        aria-pressed={
          selected
        }
      >
        ...
        <span
          className={`calendar-agenda-swatch ${tone}`}
          aria-hidden="true"
        />
        ...
        <span className="min-w-0 flex-1">
          ...
          <span className="flex flex-wrap items-center gap-x-3 gap-y-1">
            ...
            <span className="calendar-agenda-type font-mono text-[9px] font-bold tracking-[0.12em] uppercase">
              {
                EVENT_TYPE_LABEL[
                  event.event_type
                ]
            ...
            <span className="calendar-agenda-time font-mono text-[10px]">
              {timeLabel}
            </span>
          ...
          <span className="mt-1.5 block font-display text-[17px] text-parchment">
            {
              event.title
            }
          </span>
          ...
          {event.description && (
            <span className="mt-1.5 block max-w-3xl text-xs leading-relaxed text-muted-foreground">
              {
                event.description
              }
            </span>
        ...
        <span className="hidden shrink-0 items-center gap-2 sm:flex">
          ...
          {event.all_day ? null : (
            <Clock3 className="h-3.5 w-3.5 text-brass-dim" />
          )}
      ...
      {selected && (
        <div className="px-5 pb-4 sm:px-6">
          ...
          <button
            ...
            className="calendar-agenda-delete focus-legal inline-flex items-center gap-1.5 border px-2.5 py-1.5 font-mono text-[9px] font-bold uppercase transition-colors"
          >
