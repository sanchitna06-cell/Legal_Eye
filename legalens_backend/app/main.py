...
async def lifespan(app: FastAPI):
    ...
    event_bus.subscribe("text.extracted", entity_extractor.handle_text_extracted)
    event_bus.subscribe("document.uploaded", blockchain_subscriber.handle_document_uploaded)
