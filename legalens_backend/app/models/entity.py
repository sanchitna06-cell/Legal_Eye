...
from app.core.contracts import EntityExtractionSource, EntityType
...
class Entity(Base):
    ...
    extraction_source: Mapped[EntityExtractionSource] = mapped_column(
        Enum(EntityExtractionSource, name="entity_extraction_source"),
        nullable=False,
    )